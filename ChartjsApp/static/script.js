...
function addCityTag(city) {
    ...
    tag.className = 'bg-blue-100 text-[#4B89BF] text-sm font-medium px-2 py-1 rounded-full flex items-center gap-2';
    tag.innerHTML = `
        <span>${city}</span>
        <button class="text-[#7EAED9] hover:text-blue-700 focus:outline-none">&times;</button>
    `;
